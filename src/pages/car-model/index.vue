<template>
  <q-page class="q-pa-md">
    ...
    <q-toolbar class="q-py-md">
      <q-toolbar-title>汽车型号</q-toolbar-title>

      <q-btn flat round icon="las la-plus" to="/car-model/new" />
    </q-toolbar>
    ...
    <q-page-sticky position="bottom-right" :offset="[18, 18]">
      <q-btn fab icon="las la-plus" color="primary" to="/car-model/new" />
    </q-page-sticky>
  </q-page>
</template>
