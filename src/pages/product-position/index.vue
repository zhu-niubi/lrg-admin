<template>
  <q-page class="q-pa-md">
    ...
    <q-toolbar class="q-py-md">
      <q-toolbar-title>商品部位</q-toolbar-title>

      <q-btn flat round icon="las la-plus" to="/product-position/new" />
    </q-toolbar>
      ...
      <div class="q-pa-md">
        <div class="row q-col-gutter-md">
          <div class="col-xs-12 col-sm-3">
            <q-input outlined label="部位名称" v-model="queryForm.name" />
          </div>
          <div class="col-xs-12 col-sm-3">
            <GoodsOption
              title="商品类型"
              v-model="queryForm.productTypeId"
