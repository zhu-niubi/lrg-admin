<template>
  <q-page class="q-pa-md">
    ...
    <q-toolbar class="q-py-md">
      <q-toolbar-title>商品类型</q-toolbar-title>

      <q-btn flat round icon="las la-plus" to="/product-type/new" />
    </q-toolbar>
      ...
      <div class="q-pa-md">
        <div class="row q-col-gutter-md">
          <div class="col-xs-12 col-sm-3">
            <q-input outlined label="商品类型" v-model="queryForm.name" />
          </div>
          <div class="col-xs-12 col-sm-3">
            <q-btn
    ...
    <q-page-sticky position="bottom-right" :offset="[18, 18]">
      <q-btn fab icon="las la-plus" color="primary" to="/product-type/new" />
    </q-page-sticky>
  </q-page>
</template>
...
export default {
  ...
  setup() {
    ...
    // 跳转详情页
    const goto = (val) => {
      val.position = JSON.stringify(val.position);
