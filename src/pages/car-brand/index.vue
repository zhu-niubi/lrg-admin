<template>
  <q-page class="q-pa-md">
    ...
    <q-toolbar class="q-py-md">
      <q-toolbar-title>汽车品牌</q-toolbar-title>

      <q-btn flat round icon="las la-plus" to="/car-brand/new" />
    </q-toolbar>
      ...
      <div class="q-pa-md">
        <div class="row q-col-gutter-md">
          <div class="col-xs-12 col-sm-3">
            <q-input outlined label="品牌名称" v-model="queryForm.name" />
          </div>
          <div class="col-xs-12 col-sm-3">
            <q-input outlined label="首字母" v-model="queryForm.initial" />
          </div>
          <div class="col-xs-12 col-sm-3">
            <q-btn
    ...
    <q-page-sticky position="bottom-right" :offset="[18, 18]">
      <q-btn fab icon="las la-plus" color="primary" to="/car-brand/new" />
    </q-page-sticky>
  </q-page>
</template>
