<template>
  <q-page class="q-pa-md">
    ...
    <q-toolbar class="q-py-md">
      <q-toolbar-title>膜卷</q-toolbar-title>

      <q-btn flat round icon="las la-plus" to="/roll/new" />
    </q-toolbar>
      ...
      <div class="q-pa-md">
        <div class="row q-col-gutter-md">
          <div class="col-xs-12 col-sm-3">
            <q-input outlined label="膜卷号" v-model="queryForm.rollNumber" />
          </div>
          <div class="col-xs-12 col-sm-3">
            <GoodsOption
              title="商品"
    ...
    <q-page-sticky position="bottom-right" :offset="[18, 18]">
      <q-btn fab icon="las la-plus" color="primary" to="/roll/new" />
    </q-page-sticky>
  </q-page>
</template>
