<template>
  <q-page class="q-pa-md">
    ...
    <q-toolbar class="q-py-md">
      <q-toolbar-title>案例中心管理</q-toolbar-title>
    </q-toolbar>
      ...
      <div class="q-pa-md">
        <div class="row q-col-gutter-md">
          <div class="col-xs-12 col-sm-3">
            <GoodsOption
              title="产品系列"
              v-model="queryForm.productModelId"
              baseUrl="/product_model"
            />
          </div>
          <div class="col-xs-12 col-sm-3">
            <GoodsOption
